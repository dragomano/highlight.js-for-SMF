...
aliases:["yml","YAML"],contains:b}}})());hljs.registerLanguage("php-template",(()=>{"use strict";return n=>({
...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("c-like",(()=>{"use strict";function e(e){
return((...e)=>e.map((e=>(e=>e?"string"==typeof e?e:e.source:null)(e))).join(""))("(",e,")?")
...
className:"class",beginKeywords:"enum class struct union",end:/[{;:<>=]/,
contains:[{beginKeywords:"final class struct"},t.TITLE_MODE]}]),exports:{
preprocessor:c,strings:s,keywords:u}}}})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
...
},i,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,r,e.CSS_NUMBER_MODE]}]}}})());hljs.registerLanguage("css",(()=>{"use strict";return e=>{
